...
import enums.TypeSched;

public class PaymentSchedule {

	public TypeSched type;
	...
	public void setWeekly(int times, int dayWeek) {
		if(times == 1)
	...
	public int convertDayWeek( String day ) {
